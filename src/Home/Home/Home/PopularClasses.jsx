	...
	return (
		<div className="my-10">
			...
			<div className="custom-container">
				<div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mx-3 mt-2">
					{homeClasses.map((classes) => (
						<>
							<div className="rounded-lg boxShadow border-b-[3px] border-b-[#C25934] ">
